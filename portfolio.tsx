...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?q=80&w=800&auto=format&fit=crop&sat=-100", 
...
export default function Portfolio() {
  ...
  return (
    ...
    >
      ...
      {/* High-Visibility Spotlight Background Layer */}
      <div 
        className="pointer-events-none fixed inset-0 z-0 transition-opacity duration-300 mix-blend-screen opacity-100"
        style={{
          background: `radial-gradient(550px circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(255, 255, 255, 0.22), transparent 70%)`,
        }}
      />
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 flex flex-col gap-32 pb-32">
        ...
        <section id="home" className="min-h-screen w-full flex items-center pt-20">
          ...
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 hidden flex-col items-center gap-4 text-neutral-500 md:flex">
